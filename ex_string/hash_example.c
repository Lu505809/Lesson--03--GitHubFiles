...
Entry *create_hashmap(int array_size)
{
    ...
    //return (Entry *)malloc(array_size * sizeof(Entry) );//malloc won't add null value to memoray assigned so error
}
void test_hashmap_with_collisions()
{ // might work need more scenarios
